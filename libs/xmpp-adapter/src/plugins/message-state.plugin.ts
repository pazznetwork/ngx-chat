...
// import { JID, Message, MessageState, parseJid } from '@pazznetwork/ngx-chat-shared';
// import type { ChatPlugin, MessageReceivedEvent, MessageWithBodyStanza, Stanza } from '../core';
...
//     }
//
//     const el = itemElements[0] as Element;
...
//   }
//
//   beforeSendMessage(_message: NewMessage, _messageStanza: Element): void {
//     return;
...
//   }
//
//   async afterSendMessage(_message: Message, _messageStanza: Element): Promise<void> {
//     return;
//     // const type = messageStanza.getAttribute('type');
...
//     if (!from) {
//       throw new Error(
//         'No from attribute on message; message-state.plugin.acknowledgeReceivedMessage stanza=' +
//           stanza
//       );
//     }
//     firstValueFrom(this.chatService.contactListService.getOrCreateContactById(from)).then(
//       (contact) => {
...
//     if (!from) {
//       throw new Error(
//         'No from attribute on message; message-state.plugin.registerHandler stanza=' + stanza
//       );
//     }
//
...
//     if (!date) {
//       throw new Error(
//         'No date on stanza; message-state.handleStateNotificationStanza stateElement=' +
//           stateElement
//       );
//     }
//
